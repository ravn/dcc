 ...
 * macro, but dcc's frameless runtime entry captures the caller context
 * directly, so an ordinary prototype matches how it is actually called and
 * gives the editor type info. */
